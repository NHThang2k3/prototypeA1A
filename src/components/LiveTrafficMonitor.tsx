...
function LiveTrafficMonitor({ currentUser }: LiveTrafficMonitorProps) {
  ...
  return (
    // Container: Màu nền tối (#16213e) + viền sáng mờ
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Đang truy cập thời gian thực</p>
          </div>
        </div>
        
        {/* Counter Box: Nền trong suốt sáng nhẹ */}
          ...
          <div 
            ...
            className={`flex items-center justify-between p-4 rounded-xl border transition-all duration-200 ${
              visitor.isCurrentUser 
                /* Style cho bản thân: Nền xanh tối, viền xanh sáng */
                ? 'bg-blue-900/30 border-blue-500/30 shadow-lg shadow-blue-900/10' 
                /* Style cho người khác: Nền trong suốt, hover sáng nhẹ */
