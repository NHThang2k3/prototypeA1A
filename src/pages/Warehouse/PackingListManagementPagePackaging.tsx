...
const PageHeader: FC = () => (
  <div className="flex justify-between items-center mb-6">
    <h1 className="text-3xl font-bold text-gray-900">Packaging Management</h1>
    <Button className="inline-flex items-center justify-center">
      <Plus className="-ml-1 mr-2 h-5 w-5" /> Import Packaging List
    </Button>
  </div>
);
...
const PackingListTable: FC<{
  ...
  const handlePrintSingle = (item: PackagingItem) =>
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      <div className="p-4 border-b border-gray-200 bg-gray-50 flex items-center justify-between gap-4">
        <h3 className="text-lg font-semibold text-gray-800">Packaging List</h3>
