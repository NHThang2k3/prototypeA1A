// Path: src/pages/issue-accessory-form/components/AccessoryRequestSelection.tsx

import React, { useState, useEffect, useMemo } from "react";
import { Loader2, Search } from "lucide-react";
import type { AccessoryRequest } from "../types";
import { getAccessoryRequests } from "../data";

interface Props {
  onRequestSelect: (request: AccessoryRequest) => void;
}

const AccessoryRequestSelection: React.FC<Props> = ({ onRequestSelect }) => {
...
export default AccessoryRequestSelection;
